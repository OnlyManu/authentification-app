    ...
    return (
        <div className={utils.logFormWrapper}>
            ...
            <form className={utils.logForm}>
                ...
                <button className={utils.logBtn}>Login</button>
            </form>
            <div className={utils.logSocialLog}>
                ...
                <span className={utils.logSocialLogText}>Don’t have an account yet? <Link className={utils.logSocialLogLink} href="/register">Register</Link></span>
            </div>
        </div>
    )
}