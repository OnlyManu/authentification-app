    ...
    return (
        <div className={utils.logFormWrapper}>
            <Image
                ...
                priority={true}
            />
            <div className={utils.logHeadingBloc}>
                <h1 className={utils.logHeading}>Join thousands of learners from around the world</h1>
                <p className={utils.logDescription}>Master web development by making real-life projects. There are multiple paths for you to choose</p>
            </div>
            <form className={utils.logForm}>
                <div className={utils.logFormInputs}>
                    <div className={utils.logIptGroup}>
                        <svg className={utils.logIptIcon} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" />
                        </svg>
                        <input className={utils.logIpt} type="text" placeholder="Email" />
                    </div>
                    <div className={utils.logIptGroup}>
                        <svg className={utils.logIptIcon} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z" />
                        </svg>
                        <input className={utils.logIpt} type="password" placeholder="Password" />
                    </div>
                </div>
                <button className={utils.logBtn}>Start coding now</button>
            </form>
            <div className={utils.logSocialLog}>
                <span className={utils.logSocialLogText}>or continue with these social profile</span>
                <div className={utils.logSocialIcons}>
                    <div className={utils.logSocialIcon}>
                ...
                <span className={utils.logSocialLogText}>Already a member? <Link className={utils.logSocialLogLink} href="/login">Login</Link></span>
            </div>
        </div>
    )
}