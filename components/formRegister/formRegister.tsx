...
export default function FormRegister() {
  ...
  const registerWithEmail = async (e: React.FormEvent<HTMLButtonElement>) => {
    e.preventDefault();
    if (isFormValid()) {
  ...
  return (
    <div className={utils.logFormWrapper}>
      ...
      <div className={utils.logHeadingBloc}>
        <h1 className={utils.logHeading}>
          Join thousands of learners from around the world
        </h1>
        <p className={utils.logDescription}>
      ...
      <div className={utils.logSocialLog}>
        ...
        <div className={utils.logSocialIcons}>
          <div className={utils.logSocialIcon} onClick={registerWithGoogle}>
            <svg
              width="43"
              height="43"
              viewBox="0 0 43 43"
          ...
          <div className={utils.logSocialIcon} onClick={registerWithFacebook}>
            <svg
              width="43"
              height="43"
              viewBox="0 0 43 43"
          ...
          <div className={utils.logSocialIcon} onClick={registerWithGithub}>
            <svg
              width="43"
              height="43"
              viewBox="0 0 43 43"
        ...
        <span className={utils.logSocialLogText}>
          Already a member?{" "}
          <Link className={utils.logSocialLogLink} href="/login">
            Login
          </Link>
        </span>
      </div>
